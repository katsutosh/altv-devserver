...
let menumask = new UIMenuItem("1 Mask", "");
let menuhairs = new UIMenuItem("2 Hair", "");
let menutorso = new UIMenuItem("3 Torso", "");
let menulegs = new UIMenuItem("4 Legs", "");
let menubags = new UIMenuItem("5 Bags and parachute", "");
let menushoes = new UIMenuItem("6 Shoes", "");
let menuacc = new UIMenuItem("7 Accessories", "");
let menuunder = new UIMenuItem("8 Undershirt", "");
let menuarmor = new UIMenuItem("9 Armor", "")
let menudecals = new UIMenuItem("10 Decals", "");
let menutops = new UIMenuItem("11 Tops", "");
let menuhat = new UIMenuItem("0P Hats", "");
let menuglasses = new UIMenuItem("1P Glasses", "");
let menuears = new UIMenuItem("2P Ears", "");
let menuwatches = new UIMenuItem("6P Watches", "");
let menubracelets = new UIMenuItem("7P Bracelets", "");
